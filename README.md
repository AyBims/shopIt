...
project to build a functional e-commerce website(https://shopit.aybims.tech/).


To see the fundamental background of the project visit the [Project pitch](https://).
...
change to the `shopIt` directory and run the command:
